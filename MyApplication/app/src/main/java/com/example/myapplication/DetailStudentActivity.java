    ...
    public void onClick(View v) {
        if (v.getId() == R.id.img_btn_home) { // Home
            ...
            if (checklayout.equals("1")) {
                Intent intent1 = new Intent(this, StudentListActivity.class); // --> Turn to StudentListActivity
                intent1.putExtra("ID_STUDENT", id_student);
                intent1.putExtra("ID_CLASS", class_id);
                startActivity(intent1);
                finish();
            } else {
                Intent intent1 = new Intent(this, SclassListDetailActivity.class); // --> Turn to SclassListDetailActivity
                intent1.putExtra("ID_STUDENT", id_student);
                intent1.putExtra("ID_CLASS", class_id);
