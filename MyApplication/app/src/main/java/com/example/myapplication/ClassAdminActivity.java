...
public class ClassAdminActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjectlist_admin);
        mapping();
...
//                startActivity(new Intent(ClassAdminActivity.this, AdminActivity.class));
//                finish();
//                break;
//            case R.id.Img_add_student_admin:
//                startActivity(new Intent(ClassAdminActivity.this, AddSubjectAdminActivity.class));
//                finish();
//                break;
//        }
