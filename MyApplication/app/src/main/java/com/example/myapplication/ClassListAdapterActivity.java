...
public class ClassListAdapterActivity extends BaseAdapter {
    // Dữ liệu
    final ArrayList<ClassModel> LissClass;

    public ClassListAdapterActivity(ArrayList<ClassModel> lissClass) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View viewClass;
        if (convertView == null) {
            viewClass = View.inflate(parent.getContext(), R.layout.activity_class_view_custom, null);
