...
public class AddSubjectAdminActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addsubjectclass_admin);
        mapping();
...
//                startActivity(new Intent(AddSubjectAdminActivity.this, ClassAdminActivity.class));
//                finish();
//                break;
//            case R.id.img_btn_home_teacher:
//                startActivity(new Intent(AddSubjectAdminActivity.this, AdminActivity.class));
//                finish();
//                break;
//
//        }
