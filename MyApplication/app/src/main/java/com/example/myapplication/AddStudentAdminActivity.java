...
public class AddStudentAdminActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addstudent_admin);
        mapping();
...
//                startActivity(new Intent(AddStudentAdminActivity.this, StudentAdminActivity.class));
//                finish();
//                break;
//            case R.id.img_btn_home_teacher:
//                startActivity(new Intent(AddStudentAdminActivity.this, AdminActivity.class));
//                finish();
//                break;
//
//        }
