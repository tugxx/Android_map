...
public class StudentAdminActivity extends AppCompatActivity implements View.OnClickListener{
    private ImageView img_btn_back_teacher, img_btn_home_teacher, Img_add_student_admin;
    @Override
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_studentlist_admin);
        mapping();
...
//                startActivity(new Intent(StudentAdminActivity.this, AdminActivity.class));
//                finish();
//                break;
//            case R.id.Img_add_student_admin:
//                startActivity(new Intent(StudentAdminActivity.this, AddStudentAdminActivity.class));
//                finish();
//                break;
//        }
